  ...
  return (
    <div className="min-h-screen flex items-start justify-center py-10">
      ...
      >
        ...
        {/* 댓글 작성 폼 */}
        <div className="mb-6 flex items-stretch h-13 justify-between ">
          <textarea
          ...
          />
          <button
            className="ml-4 h-full px-5 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition"
            onClick={() => console.log("댓글 작성 클릭")}
          >
            작성
          </button>
        </div>
